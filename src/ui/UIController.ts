...
export class UIController {
  ...
  constructor(private simulation: SimulationEngine) {
    ...
    // Create feedback button as a separate element appended to body
    // (position:fixed doesn't work inside backdrop-filter containers)
    ...
    // Hover effect for feedback button is set up in createFeedbackButton()
  ...
  // Create feedback button appended directly to body (avoids backdrop-filter containment)
